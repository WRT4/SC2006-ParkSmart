      ...
      <section className="grid justify-center gap-4 p-6 sm:gap-10 sm:p-10">
        ...
        <div className="grid w-full grid-cols-[repeat(auto-fit,_minmax(250px,_1fr))] justify-items-center gap-6 min-[1000px]:max-w-[1090px] min-[1000px]:grid-cols-3">
          ...
          >
            ...
            <p className="font-semibold">{t("home__myProfile")}</p>
            <p className="text-sm text-gray-600">{t("home__viewAndManage")}</p>
          ...
          >
            ...
            <p className="font-semibold">{t("home__carparkSearch")}</p>
          ...
          >
            ...
            <p className="font-semibold">{t("home__forum")}</p>
            <p className="text-sm text-gray-600">
          ...
          >
            ...
            <p className="font-semibold">{t("home__provideFeedback")}</p>
            <p className="text-sm text-gray-600">
          ...
          >
            ...
            <p className="font-semibold">{t("home__about")}</p>
            <p className="text-sm text-gray-600">
          ...
          >
            ...
            <p className="font-semibold">{t("home__license")}</p>
            <p className="text-sm text-gray-600">
