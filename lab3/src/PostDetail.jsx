...
function PostDetail() {
    ...
    const deletePost = () => {
        ...
        if (confirmDelete) {
            ...
            axios.patch(`http://localhost:5000/api/posts/${id}`, { deleted: true })
                .then(() => {
    ...
    const deleteComment = (commentId) => {
        ...
        if (confirmDelete) {
            ...
            axios.delete(`http://localhost:5000/api/posts/${id}/comments/${commentId}`)
                .then(() => {
    ...
    const reportPost = () => {
        ...
        axios.post(`http://localhost:5000/api/posts/${id}/report`, {
    ...
    const reportComment = (commentId) => {
        ...
        axios.post(`http://localhost:5000/api/posts/${id}/comments/${commentId}/report`, {
            username: user.username,
            report: reportText
        })
        .then(res => {
                        ...
                        .map((c, index) => (
                            <div key={index} className="comment">
                                ...
                                {user && user.username === c.username && (
                                    <>
                                        <button onClick={() => editComment(c._id, c.text)}>Edit Comment</button>
                                ...
                                {user && user.username !== c.username && (
                                    <>
                                        <button onClick={() => setReportingCommentId(c._id)}>Report Comment</button>
                                    </>
                                )}
                                ...
                                {reportingCommentId === c._id && (
                                    <div>
                                        ...
                                        />
                                        <button onClick={() => reportComment(c._id)}>Submit Report</button>
                                        <button onClick={() => setReportingCommentId(null)}>Cancel</button>
                                    </div>
                                )}
                            </div>
                        ))
